...
public class ServerAsymmetricSignatureSignerContextBackPorted extends AsymmetricSignatureSignerContext {

    public ServerAsymmetricSignatureSignerContextBackPorted(KeycloakSession session, String algorithm) throws SignatureException {
